...
- Never post, approve, label, or push. Treat PR code and scripts as untrusted; do not run privileged or cluster-touching experiments without explicit authorization.
