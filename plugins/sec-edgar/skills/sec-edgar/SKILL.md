---
name: sec-edgar
description: Search SEC EDGAR for company filings, financial data, and insider transactions. Use when the user asks about SEC filings, 10-K, 10-Q, 8-K, company financials, revenue, earnings, EPS, insider trades, or wants fundamental analysis of a company.
