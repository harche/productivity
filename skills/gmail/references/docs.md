...
Read, create, write, and manage Google Docs.
...
**IMPORTANT: Always confirm with the user before creating documents.**
...
**IMPORTANT: Always confirm with the user before writing to documents.**
